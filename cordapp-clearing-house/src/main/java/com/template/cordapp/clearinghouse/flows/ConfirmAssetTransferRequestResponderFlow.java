...
@Metadata(
   ...
   d2 = {"Lcom/synechron/cordapp/clearinghouse/flows/ConfirmAssetTransferRequestResponderFlow;", "Lnet/corda/core/flows/FlowLogic;", "Lnet/corda/core/transactions/SignedTransaction;", "otherSideSession", "Lnet/corda/core/flows/FlowSession;", "(Lnet/corda/core/flows/FlowSession;)V", "call", "cordapp-clearing-house"}
)
public final class ConfirmAssetTransferRequestResponderFlow extends FlowLogic {
   ...
   public ConfirmAssetTransferRequestResponderFlow(@NotNull FlowSession otherSideSession) {
